...
local Button_Icon = "rbxassetid://123035624465678" 
----------------------------
...
local Themes = {
	...
	Dark = {
		Name = "Dark",
		Accent = Color3.fromRGB(160, 90, 255), -- Ungu cerah
		AcrylicMain = Color3.fromRGB(20, 20, 20), -- Hitam
		AcrylicBorder = Color3.fromRGB(50, 50, 50), -- Abu-abu gelap
		AcrylicGradient = ColorSequence.new(Color3.fromRGB(15, 15, 15), Color3.fromRGB(15, 15, 15)), -- Hitam pekat
		AcrylicNoise = 0.9,
		TitleBarLine = Color3.fromRGB(45, 45, 45), -- Abu-abu gelap
		Tab = Color3.fromRGB(160, 90, 255), -- Ungu cerah
		Element = Color3.fromRGB(160, 90, 255), -- Ungu cerah
		ElementBorder = Color3.fromRGB(25, 25, 25), -- Hitam pekat
		InElementBorder = Color3.fromRGB(90, 90, 90), -- Abu-abu
		ElementTransparency = 0.87,
		ToggleSlider = Color3.fromRGB(160, 90, 255), -- Ungu cerah
		ToggleToggled = Color3.fromRGB(42, 42, 42), -- Abu-abu gelap
		SliderRail = Color3.fromRGB(160, 90, 255), -- Ungu cerah
		DropdownFrame = Color3.fromRGB(160, 90, 255), -- Ungu cerah
		DropdownHolder = Color3.fromRGB(30, 30, 30), -- Hitam pekat
		DropdownBorder = Color3.fromRGB(25, 25, 25), -- Hitam pekat
		DropdownOption = Color3.fromRGB(160, 90, 255), -- Ungu cerah
		Keybind = Color3.fromRGB(160, 90, 255), -- Ungu cerah
		Input = Color3.fromRGB(160, 90, 255), -- Ungu cerah
		InputFocused = Color3.fromRGB(10, 10, 10), -- Hitam pekat
		InputIndicator = Color3.fromRGB(180, 120, 255), -- Ungu lebih terang
		Dialog = Color3.fromRGB(30, 30, 30), -- Hitam pekat
		DialogHolder = Color3.fromRGB(25, 25, 25), -- Hitam pekat
		DialogHolderLine = Color3.fromRGB(20, 20, 20), -- Hitam pekat
		DialogButton = Color3.fromRGB(160, 90, 255), -- Ungu cerah
		DialogButtonBorder = Color3.fromRGB(100, 50, 150), -- Ungu lebih gelap
		DialogBorder = Color3.fromRGB(90, 50, 150), -- Ungu lebih gelap
		DialogInput = Color3.fromRGB(45, 45, 45), -- Abu-abu gelap
		DialogInputLine = Color3.fromRGB(180, 120, 255), -- Ungu lebih terang
		Text = Color3.fromRGB(240, 240, 240), -- Putih untuk kontras
		SubText = Color3.fromRGB(170, 170, 170), -- Abu-abu
		Hover = Color3.fromRGB(180, 120, 255), -- Ungu lebih terang
		HoverChange = 0.07,
	},
	Darker = {
		Name = "Darker",
...
local MinimizeButton = New("TextButton", {
	...
	New("ImageLabel", {
		Image = Mobile and Button_Icon or "rbxassetid://123035624465678" or "",
		Size = UDim2.new(1, 0, 1, 0),
		BackgroundTransparency = 1,
	}, {
...
if Mobile then
	...
	Minimizer = New("Frame", {
	        Parent = GUI,
	        Size = UDim2.new(0.03, 0, 0.06, 0), -- Ukuran lebih kecil untuk PC
	        Position = UDim2.new(0.45, 0, 0.025, 0),
	        BackgroundTransparency = 1,
	        ZIndex = 999999999,
	    },
	    {
	        New("Frame", {
	            BackgroundColor3 = Color3.fromRGB(0, 0, 0),
	            Size = UDim2.new(1, 0, 1, 0),
	            BackgroundTransparency = 0.5, -- Transparan sedikit supaya kelihatan
	            BorderSizePixel = 0
	        }, {
	            New("UICorner", {
	                CornerRadius = UDim.new(0.5, 0), -- Lebih bulat di PC
	            }),
	            MinimizeButton
	        })
	    })
